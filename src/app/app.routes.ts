...
const seo = {
  ...
  learn: {
    ...
    articleItems: [
      ...
      { title: 'What Is the Model Context Protocol (MCP)?', path: '/learn/en/what-is-model-context-protocol-mcp', imagePath: '/assets/learn/model-context-protocol-mcp-cover.png' },
      ...
      { title: '¿Qué es el Model Context Protocol (MCP)?', path: '/learn/es/que-es-model-context-protocol-mcp', imagePath: '/assets/learn/model-context-protocol-mcp-cover.png' },
      ...
      ,{ title: 'O que é o Model Context Protocol (MCP)?', path: '/learn/pt/o-que-e-model-context-protocol-mcp', imagePath: '/assets/learn/model-context-protocol-mcp-cover.png' }
    ]
  },
  ...
  learnMcpPortuguese: {
    title: 'O que é o Model Context Protocol (MCP)? Guia completo', description: 'Entenda o Model Context Protocol (MCP), servidores, clientes, arquitetura, ferramentas, recursos, prompts, segurança, autorização e integração com agentes de IA.', keywords: 'o que é Model Context Protocol, MCP, servidor MCP, cliente MCP, arquitetura MCP, ferramentas MCP, recursos MCP, prompts MCP, agentes de IA, integração LLM, segurança MCP, servidor MCP Python', canonicalPath: '/learn/pt/o-que-e-model-context-protocol-mcp', pageType: 'article', imagePath: '/assets/learn/model-context-protocol-mcp-cover.png', imageWidth: 1536, imageHeight: 1024, imageAlt: 'Host de IA conectado por um hub seguro do Model Context Protocol a ferramentas, recursos, prompts, código e dados', publishedTime: '2026-07-23T00:00:00-03:00', modifiedTime: '2026-07-23T00:00:00-03:00', author: 'João Ricardo Dutra', section: 'Fundamentos e Arquitetura de APIs Corporativas', language: 'pt-BR', locale: 'pt_BR', tags: ['Model Context Protocol','MCP','MCP Server','MCP Client','AI Agents','LLM Integration','JSON-RPC','Streamable HTTP','MCP Security','Python'], alternateLanguages: [{language:'pt-BR',path:'/learn/pt/o-que-e-model-context-protocol-mcp',locale:'pt_BR'},{language:'en',path:'/learn/en/what-is-model-context-protocol-mcp',locale:'en_US'},{language:'es',path:'/learn/es/que-es-model-context-protocol-mcp',locale:'es_ES'},{language:'x-default',path:'/learn/en/what-is-model-context-protocol-mcp'}]
  },
  learnMcpEnglish: {
    title: 'What Is Model Context Protocol (MCP)? Complete Guide', description: 'Learn what Model Context Protocol (MCP) is, how MCP servers and clients work, its architecture, tools, resources, prompts, security risks, authorization, and a Python example.', keywords: 'what is Model Context Protocol, MCP, MCP server, MCP client, MCP architecture, MCP tools, MCP resources, MCP prompts, AI agents, LLM integration, MCP security, Python MCP server', canonicalPath: '/learn/en/what-is-model-context-protocol-mcp', pageType: 'article', imagePath: '/assets/learn/model-context-protocol-mcp-cover.png', imageWidth: 1536, imageHeight: 1024, imageAlt: 'AI host connected through a secure Model Context Protocol hub to tools, resources, prompts, code, and data', publishedTime: '2026-07-23T00:00:00-03:00', modifiedTime: '2026-07-23T00:00:00-03:00', author: 'João Ricardo Dutra', section: 'Corporate API Fundamentals and Architecture', language: 'en', locale: 'en_US', tags: ['Model Context Protocol','MCP','MCP Server','MCP Client','AI Agents','LLM Integration','JSON-RPC','Streamable HTTP','MCP Security','Python'], alternateLanguages: [{language:'pt-BR',path:'/learn/pt/o-que-e-model-context-protocol-mcp',locale:'pt_BR'},{language:'en',path:'/learn/en/what-is-model-context-protocol-mcp',locale:'en_US'},{language:'es',path:'/learn/es/que-es-model-context-protocol-mcp',locale:'es_ES'},{language:'x-default',path:'/learn/en/what-is-model-context-protocol-mcp'}]
  },
  learnMcpSpanish: {
    title: '¿Qué es el Model Context Protocol (MCP)? Guía completa', description: 'Descubre qué es Model Context Protocol (MCP), cómo funcionan servidores y clientes, su arquitectura, herramientas, recursos, prompts, seguridad, autorización y un ejemplo en Python.', keywords: 'qué es Model Context Protocol, MCP, servidor MCP, cliente MCP, arquitectura MCP, herramientas MCP, recursos MCP, prompts MCP, agentes de IA, integración LLM, seguridad MCP, servidor MCP Python', canonicalPath: '/learn/es/que-es-model-context-protocol-mcp', pageType: 'article', imagePath: '/assets/learn/model-context-protocol-mcp-cover.png', imageWidth: 1536, imageHeight: 1024, imageAlt: 'Host de IA conectado mediante un hub seguro de Model Context Protocol a herramientas, recursos, prompts, código y datos', publishedTime: '2026-07-23T00:00:00-03:00', modifiedTime: '2026-07-23T00:00:00-03:00', author: 'João Ricardo Dutra', section: 'Fundamentos y Arquitectura de APIs Corporativas', language: 'es', locale: 'es_ES', tags: ['Model Context Protocol','MCP','MCP Server','MCP Client','AI Agents','LLM Integration','JSON-RPC','Streamable HTTP','MCP Security','Python'], alternateLanguages: [{language:'pt-BR',path:'/learn/pt/o-que-e-model-context-protocol-mcp',locale:'pt_BR'},{language:'en',path:'/learn/en/what-is-model-context-protocol-mcp',locale:'en_US'},{language:'es',path:'/learn/es/que-es-model-context-protocol-mcp',locale:'es_ES'},{language:'x-default',path:'/learn/en/what-is-model-context-protocol-mcp'}]
  },
  whatIsUtilyTools: {
...
export const routes: Routes = [
  ...
  { path: 'learn/pt/o-que-e-model-context-protocol-mcp', loadComponent: () => import('./learn/protocolo-contexto-modelo-mcp-pt/protocolo-contexto-modelo-mcp-pt.component').then((m) => m.ProtocoloContextoModeloMcpPtComponent), data: { seo: seo.learnMcpPortuguese } },
  { path: 'learn/en/what-is-model-context-protocol-mcp', loadComponent: () => import('./learn/model-context-protocol-mcp-en/model-context-protocol-mcp-en.component').then((m) => m.ModelContextProtocolMcpEnComponent), data: { seo: seo.learnMcpEnglish } },
  { path: 'learn/es/que-es-model-context-protocol-mcp', loadComponent: () => import('./learn/protocolo-contexto-modelo-mcp-es/protocolo-contexto-modelo-mcp-es.component').then((m) => m.ProtocoloContextoModeloMcpEsComponent), data: { seo: seo.learnMcpSpanish } },
